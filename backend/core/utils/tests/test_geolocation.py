...
class TestGeographicRestrictionValidation:
    ...
    @patch("core.utils.geolocation.get_country_from_ip")
    def test_validate_geographic_restriction_not_allowed_country(
        self, mock_get_country
    ):
    ...
    @patch("core.utils.geolocation.get_country_from_ip")
    def test_validate_geographic_restriction_blocked_takes_priority(
        self, mock_get_country
    ):
    ...
    @patch("core.utils.geolocation.get_country_from_ip")
    def test_validate_geographic_restriction_cannot_determine_country(
        self, mock_get_country
    ):
    ...
    def test_validate_geographic_restriction_allowed_region(
        self, mock_get_region, mock_get_country
    ):
    ...
    @patch("core.utils.geolocation.get_country_from_ip")
    @patch("core.utils.geolocation.get_region_from_ip")
    def test_validate_geographic_restriction_blocked_region(
        self, mock_get_region, mock_get_country
    ):
    ...
    @patch("core.utils.geolocation.get_country_from_ip")
    @patch("core.utils.geolocation.get_region_from_ip")
    def test_validate_geographic_restriction_region_not_allowed(
        self, mock_get_region, mock_get_country
    ):
